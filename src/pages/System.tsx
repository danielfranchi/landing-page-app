    ...
    <div className="relative grid grid-cols-1 gap-8 bg-white p-8 md:grid-cols-[1.5fr_1fr]">
      <div className="relative flex justify-center items-center order-last md:order-last">
        <img
          src={BlobOrange}
          alt="Blob Purple"
          className="absolute top-0 left-0 w-full max-w-[600px] md:max-w-[550px] sm:max-w-[300px] h-auto dd"
        />
        <img
          src={MobileApp}
          alt="Mobile Mockup"
          className="relative z-10 w-full max-w-[300px] md:max-w-[500px] h-auto rounded-lg ee"
        />
      </div>
      ...
      <div className="flex flex-col justify-center order-first md:order-first">
        ...
        <p className="text-[16px] sm:text-[20px] font-normal leading-[24px] sm:leading-[36px] text-primary mt-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mt-8">
          <div>
            ...
            <p className="text-[16px] sm:text-[18px] font-normal text-primary">
